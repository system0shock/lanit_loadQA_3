# 1 "c:\\users\\omega\\documents\\vugen\\scripts\\tutorial\\scripts\\lanit_loadqa\\uc_10_complex_scenario\\\\combined_UC_10_Complex_Scenario.c"
...
# 1 "c:\\users\\omega\\documents\\vugen\\scripts\\tutorial\\scripts\\lanit_loadqa\\uc_10_complex_scenario\\\\combined_UC_10_Complex_Scenario.c" 2
...
# 2 "c:\\users\\omega\\documents\\vugen\\scripts\\tutorial\\scripts\\lanit_loadqa\\uc_10_complex_scenario\\\\combined_UC_10_Complex_Scenario.c" 2
...
# 3 "c:\\users\\omega\\documents\\vugen\\scripts\\tutorial\\scripts\\lanit_loadqa\\uc_10_complex_scenario\\\\combined_UC_10_Complex_Scenario.c" 2
...
# 4 "c:\\users\\omega\\documents\\vugen\\scripts\\tutorial\\scripts\\lanit_loadqa\\uc_10_complex_scenario\\\\combined_UC_10_Complex_Scenario.c" 2
...
# 5 "c:\\users\\omega\\documents\\vugen\\scripts\\tutorial\\scripts\\lanit_loadqa\\uc_10_complex_scenario\\\\combined_UC_10_Complex_Scenario.c" 2
...
Login()
{
	...
	lr_end_transaction("UC10_open_login_form",2);
	...
	if (HTTP_rc < 400){
		...
		lr_end_transaction("UC10_login",0);
	} else {
		lr_log_message("auth fail");
		lr_end_transaction("UC10_login",1);
	}
	
}
# 6 "c:\\users\\omega\\documents\\vugen\\scripts\\tutorial\\scripts\\lanit_loadqa\\uc_10_complex_scenario\\\\combined_UC_10_Complex_Scenario.c" 2
...
Pagination()
{
	...
	lr_end_transaction("TR04_select_entries_qnt",2);
	...
	lr_end_transaction("TR05_open_random_page",2);
	...
	lr_end_transaction("TR06_logout",2);

	return 0;
	return 0;
}
# 7 "c:\\users\\omega\\documents\\vugen\\scripts\\tutorial\\scripts\\lanit_loadqa\\uc_10_complex_scenario\\\\combined_UC_10_Complex_Scenario.c" 2
...
CreateTask()
{
	...
	lr_end_transaction("UC03_TR03_open_new_ticket_page",2);
	...
	lr_end_transaction("UC03_TR04_submit_new_ticket",2);
	return 0;
}
# 8 "c:\\users\\omega\\documents\\vugen\\scripts\\tutorial\\scripts\\lanit_loadqa\\uc_10_complex_scenario\\\\combined_UC_10_Complex_Scenario.c" 2
...
DeleteTask()
{
	...
	lr_end_transaction("TR03_show_duplicates",2);
	...
	lr_end_transaction("TR05_open_highest_priority_ticket",2);
	...
	lr_end_transaction("TR07_select_and_delete_ticket",2);
	return 0;
}
# 9 "c:\\users\\omega\\documents\\vugen\\scripts\\tutorial\\scripts\\lanit_loadqa\\uc_10_complex_scenario\\\\combined_UC_10_Complex_Scenario.c" 2
...
# 10 "c:\\users\\omega\\documents\\vugen\\scripts\\tutorial\\scripts\\lanit_loadqa\\uc_10_complex_scenario\\\\combined_UC_10_Complex_Scenario.c" 2
...
# 11 "c:\\users\\omega\\documents\\vugen\\scripts\\tutorial\\scripts\\lanit_loadqa\\uc_10_complex_scenario\\\\combined_UC_10_Complex_Scenario.c" 2
