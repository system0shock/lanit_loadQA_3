vuser_init()
{
	...
	lr_start_transaction("UC05_TR01_open_login_page");
...
/*Correlation comment - Do not change!  Original value='Wjwfc1jwvZAapb0OttWdGoPrMbrMu0JOBmH47xtxmwO9Gbr2Ik0uWZ4lUWUaG49f' Name ='csrfmiddlewaretoken' Type ='ResponseBased'*/
	...
	lr_end_transaction("UC05_TR01_open_login_page",LR_AUTO);

	lr_start_transaction("UC05_TR02_user_login");
...
//    LAST);
	...
	lr_end_transaction("UC05_TR02_user_login",LR_AUTO);web_add_cookie("csrftoken=Z3rEe2cIEcUV6kCnfcLYGGDk5CUO6z2GE6Ct9ymJvJ8Unk3Bu3PfWhSednnciDs7; DOMAIN={host}");
...
/*Correlation comment - Do not change!  Original value='DQYmSSPrUpGQQus23gCjB49Mp7Ri9JsCEJ8ewN4JkHJ4guIC1LbZYKQyBRvc2wau' Name ='csrftoken' Type ='ResponseBased'*/
	...
	lr_end_transaction("UC05_TR02_user_login",LR_AUTO);
